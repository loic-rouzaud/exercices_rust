// TODO(): Implémentez la fonction swap qui échange deux valeurs de n'importe quel type.
// La fonction doit prendre deux références mutables vers des valeurs du même type
// et échanger leur contenu.

fn swap<T>(/* complétez les paramètres */) {
